...
class LocalOperatorsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.term_a = local_terms.LocalTerm(
            self.operators_a, self.coefficient_a)
        self.term_b = local_terms.LocalTerm(
            self.operators_b, self.coefficient_b)
        self.term_c = local_terms.LocalTerm(
            self.operators_c, self.coefficient_c)
    ...
    def test_init_list_protection(self):
        ...
        expected_term = local_terms.LocalTerm(
            self.operators1[:-1], self.coeff1,)
