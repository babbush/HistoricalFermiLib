...
class LocalOperator(object):
    ...
    Attributes:   terms: Dictionary of LocalTerm objects.
    ...
    def __iadd__(self, addend):
        ...
        Raises:
          LocalOperatorError: Cannot add terms acting on different Hilbert
            spaces.
        ...
        if issubclass(type(addend), local_terms.LocalTerm):
            ...
            new_coefficient = self[tuple(
                addend.operators)] + addend.coefficient
    ...
    def __imul__(self, multiplier):
        ...
        Raises:
          ...
          LocalOperatorError: Cannot multiply terms on different Hilbert
            spaces.
        """
        # Handle scalars.
